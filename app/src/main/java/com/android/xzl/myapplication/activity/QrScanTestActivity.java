...
public class QrScanTestActivity extends AppCompatActivity implements QRCodeView.Delegate {
    ...
    private static final String TAG = "QrScanTestActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mZXingView = (ZXingView) findViewById(R.id.zbarview);
...
//        mZXingView.startCamera(Camera.CameraInfo.CAMERA_FACING_FRONT); // 打开前置摄像头开始预览，但是并未开始识别
    ...
    public void onScanQRCodeSuccess(String result) {
        ...
        intent.putExtra("jieguo", result);// 放入返回值
        setResult(111, intent);// 放入回传的值,并添加一个Code,方便区分返回的数据
